        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="flex justify-end">
                    <a class="px-8" href="{{ route('admin.productos.create') }}">
                    ...
                    <table class="border-collapse border border-slate-500 ">
                        <thead>
                            <tr>
                                ...
                                <th class="border boder-gray-400 px-4 py-2 text-gray-800">Marca</th>
                                <th class="border boder-gray-400 px-4 py-2 text-gray-800">Código</th>
                                <th class="border boder-gray-400 px-4 py-2 text-gray-800">SKU</th>
                                <th class="border boder-gray-400 px-4 py-2 text-gray-800">Descripción</th>
                                <th class="border boder-gray-400 px-4 py-2 text-gray-800">Existencias</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
